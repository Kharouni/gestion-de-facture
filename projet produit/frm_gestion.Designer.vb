...
Partial Class frm_gestion
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Location = New Point(279, 31)
        ...
        Label3.Location = New Point(279, 113)
        ...
        Label4.Location = New Point(281, 159)
        ...
        ' btn_supprimer
        ' 
        btn_supprimer.Location = New Point(485, 251)
        ...
        ' btn_vider
        ' 
        btn_vider.Location = New Point(357, 255)
        ...
        ' btn_modifier
        ' 
        btn_modifier.Location = New Point(178, 252)
        ...
        Label5.Location = New Point(66, 333)
        Label5.Name = "Label5"
        ...
        Label6.Location = New Point(257, 333)
        Label6.Name = "Label6"
        ...
        Label7.Location = New Point(505, 333)
        Label7.Name = "Label7"
        ...
        Label8.Location = New Point(712, 333)
        Label8.Name = "Label8"
        ...
        lst_p.ItemHeight = 25
        lst_p.Location = New Point(31, 391)
        lst_p.Name = "lst_p"
        lst_p.Size = New Size(166, 229)
        lst_p.TabIndex = 16
        ' 
        ' lst_pu
        ' 
        lst_pu.FormattingEnabled = True
        lst_pu.ItemHeight = 25
        lst_pu.Location = New Point(241, 391)
        lst_pu.Name = "lst_pu"
        lst_pu.Size = New Size(172, 229)
        lst_pu.TabIndex = 17
        ' 
        ' lst_q
        ' 
        ...
        lst_q.ItemHeight = 25
        lst_q.Location = New Point(470, 391)
        lst_q.Name = "lst_q"
        lst_q.Size = New Size(172, 229)
        lst_q.TabIndex = 18
        ' 
        ' lst_m
        ' 
        ...
        lst_m.ItemHeight = 25
        lst_m.Location = New Point(708, 391)
        lst_m.Name = "lst_m"
        lst_m.Size = New Size(172, 229)
        lst_m.TabIndex = 19
        ' 
        ' btn_total
        ' 
        btn_total.AutoSize = True
        btn_total.Location = New Point(106, 656)
        ...
        ' txt_tpu
        ' 
        txt_tpu.Location = New Point(241, 656)
        txt_tpu.Name = "txt_tpu"
        txt_tpu.Size = New Size(181, 31)
        txt_tpu.TabIndex = 21
        ' 
        ' txt_tq
        ' 
        txt_tq.Location = New Point(485, 650)
        txt_tq.Name = "txt_tq"
        txt_tq.Size = New Size(181, 31)
        txt_tq.TabIndex = 22
        ' 
        ' txt_tm
        ' 
        txt_tm.Location = New Point(699, 650)
        txt_tm.Name = "txt_tm"
        txt_tm.Size = New Size(181, 31)
        txt_tm.TabIndex = 23
        ' 
        ' btn_tva
        ' 
        btn_tva.AutoSize = True
        btn_tva.Location = New Point(232, 747)
        ...
        ' txt_tva
        ' 
        txt_tva.Location = New Point(399, 732)
        txt_tva.Name = "txt_tva"
        txt_tva.Size = New Size(324, 31)
        txt_tva.TabIndex = 25
        ' 
        ' txt_remise
        ' 
        txt_remise.Location = New Point(399, 807)
        txt_remise.Name = "txt_remise"
        txt_remise.Size = New Size(324, 31)
        txt_remise.TabIndex = 26
        ' 
        ' btn_remise
        ' 
        btn_remise.AutoSize = True
        btn_remise.Location = New Point(232, 813)
        ...
        ' btn_calcul
        ' 
        btn_calcul.Location = New Point(357, 859)
        btn_calcul.Name = "btn_calcul"
        btn_calcul.Size = New Size(145, 50)
        ...
        ' btn_quitter
        ' 
        btn_quitter.Location = New Point(567, 859)
        btn_quitter.Name = "btn_quitter"
        btn_quitter.Size = New Size(145, 50)
